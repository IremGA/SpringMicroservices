...
import org.eaetirk.demo.kafka.streams.service.constants.Constants;
...
public class KafkaStreamUserJWTConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public KafkaStreamUserJWTConverter(KafkaStreamUserDetailsService kafkaStreamUserDetailsService) {
    ...
    public AbstractAuthenticationToken convert(Jwt source) {
        ...
        return Optional.ofNullable(kafkaStreamUserDetailsService
                .loadUserByUsername(source.getClaimAsString(USERNAME_CLAIM)))
                .map(userDetails -> {
                    ((KafkaStreamUser) userDetails).setAuthorities(authorities);
