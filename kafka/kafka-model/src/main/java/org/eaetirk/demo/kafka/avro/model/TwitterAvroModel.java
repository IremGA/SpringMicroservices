 ...
 */
package org.eaetirk.demo.kafka.avro.model;
...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8991095120150890736L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"org.eaetirk.demo.kafka.avro.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder() {
    return new org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder(org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder();
    } else {
      return new org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder(org.eaetirk.demo.kafka.avro.model.TwitterAvroModel other) {
    if (other == null) {
      return new org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder();
    } else {
      return new org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.eaetirk.demo.kafka.avro.model.TwitterAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder setText(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.eaetirk.demo.kafka.avro.model.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
