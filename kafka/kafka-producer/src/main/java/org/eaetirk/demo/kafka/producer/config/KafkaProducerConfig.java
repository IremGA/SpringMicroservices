package org.eaetirk.demo.kafka.producer.config;

import org.apache.avro.specific.SpecificRecordBase;
import org.apache.kafka.clients.producer.ProducerConfig;
import org.eaetirk.demo.config.KafkaConfigData;
import org.eaetirk.demo.config.KafkaProducerConfigData;
...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    @Bean
    public ProducerFactory<K, V> producerFactoryX() {
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }

    @Bean
    public KafkaTemplate<K, V> kafkaTemplate() {
        return new KafkaTemplate<>(producerFactoryX());
    }
}
