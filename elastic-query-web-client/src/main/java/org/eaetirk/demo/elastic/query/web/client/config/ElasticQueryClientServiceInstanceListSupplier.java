...
@Configuration
@Primary
public class ElasticQueryClientServiceInstanceListSupplier implements ServiceInstanceListSupplier {
    private final ElasticQueryWebClientConfigData.WebClient webClientConfigData;

    public ElasticQueryClientServiceInstanceListSupplier(ElasticQueryWebClientConfigData webClientConfigData) {
    ...
    public Flux<List<ServiceInstance>> get() {
        return Flux.just(webClientConfigData.getInstances().stream().map(
                instance ->
